(function () {
    ...
    onexecute = async function ({
      ...
      try {
        switch (objectName) {
          case "bucket":
            await onexecuteBucket(methodName, parameters, properties, configuration);
            break;
    ...
    async function onexecuteBucket(methodName, parameters, properties, configuration) {
      try {
        switch (methodName) {
          case "getList":
            await onexecuteBucketGetList(parameters, properties, configuration);
            break;
    ...
    async function onexecuteFile(methodName, properties, parameters) {
      try {
        switch (methodName) {
          case "getFile":
            await onexecuteGetFile(parameters, properties);
            break;
    ...
    function onexecuteBucketGetList(parameters, properties, configuration) {
    ...
    function onexecuteGetFile(parameters, properties) {
      return new Promise((resolve, reject) => {
